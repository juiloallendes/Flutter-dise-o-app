      ...
      children: [
        TableRow(
          children: [
            ...
            _crearBotonRedondeado( Colors.purpleAccent, Icons.business_center, 'busines' ),
          ],
        ),
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.red, Icons.border_all, 'General' ),
            _crearBotonRedondeado( Colors.redAccent, Icons.cake, 'briday' ),
          ],
        ),
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.amber, Icons.chat, 'General' ),
            _crearBotonRedondeado( Colors.deepOrange, Icons.pie_chart_outlined, 'General' ),
          ],
        ),
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.deepOrangeAccent, Icons.home, 'General' ),
            _crearBotonRedondeado( Colors.yellow, Icons.hot_tub, 'General' ),
          ],
        ),
      ],
    );
